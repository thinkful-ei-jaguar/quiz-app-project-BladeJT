...
function startQuiz(){
  ...
  <div class = 'start-quiz'>
    <!-- We will remove anchors and use event listeners in the final app-->  
    <a href = "questions.html"><input type = 'button' id = 'begin-button' value = 'Begin the quiz'></a>     
  </div>
</body>`;
...
function questionPage(){
  ...
  <form class = 'radio-answers'>
    ...
    <a href = 'feedback.html'><input type = 'button' id = 'submit-button' value = 'Submit answer'></a>
  </form>
</body>
  `;
}
...
function resultsPage(){
  ...
  <div class = 'restart-quiz'>
    <!-- We will remove anchors and use event listeners in the final app-->
    <a href = 'index.html'><input type = 'button' id = 'restart-button' value = 'Restart quiz?'></a>     
  </div>
...
function feedbackPage(){
  ...
  <form class = 'radio-answers'>
      ...
      <!-- We will remove anchors and use event listeners in the final app-->
      <a href = 'quizResults.html'><input type = 'button' id = 'submit-button' value = 'Next question'></a>
    </form>
</body>
  `;
}
